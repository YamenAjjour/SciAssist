...
python scirag/setup_rag.py --path-index /home/yamen/projects/sciassist/data/index --path-dataset /home/yamen/projects/sciassist/data/acl-publication-info.74k.parquet
